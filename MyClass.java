...
// when you have main methid inside of any class the class must be defined as public and the java file name should be same as class name .
// In this case filke name should be saved as MyClass.java ;

public class MyClass {
    public static void main(String args[]) {
    
    // In below line we are creating an object of an class 
    // An object is Instance of an class
     Student s1 = new Student("Hardik Thakre", 20, 3);
     s1.display();
     
     // dot operator is used to access the class variables or methods used with reference variable;
     // this.age = s1.age;
     
     
     // below object will call constructor with 2 parameters
     Student s2 = new Student("Prakash goswami", 22);
     s2.display();
     
     //keywords are the reserved name in java . you cannot use keyword name as variables and methods in java.
     // int this; this will throw an error
     
    }
}

class Student{
    // Class is a templete for an object !!
    ...
    // Constructors are the special method used to instansiate objects.
    //The constructor is called when an object of a class is created.
    Student(String FullName ,int age,int year){
        // This keyword is used to refer to ths current object.
    ...
    void display(){
        System.out.println("Student Full Name is "+ this.FullName +" age is "+ this.age +" studying in "+ this.year);
    }
}
